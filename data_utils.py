...
if __name__ == "__main__":
    # Test loading AG News data
    train_sentences_ag, train_labels_ag, test_sentences_ag, test_labels_ag = load_agnews()
    # Test loading DBpedia data
    train_sentences_db, train_labels_db, test_sentences_db, test_labels_db = load_dbpedia()
    # Test loading TREC data
    train_sentences_trec, train_labels_trec, test_sentences_trec, test_labels_trec = load_trec()
